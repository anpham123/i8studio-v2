...
│
├── lib/
│   ├── prisma.ts                    # Singleton: globalThis.__prisma
...
model EmailSubscriber {
  ...
  email     String   @unique
  name      String   @default("")
  source    String   @default("")           // EXIT_POPUP | FOOTER | INLINE
  createdAt DateTime @default(now())
}

model AnalyticsEvent {
  id        String   @id @default(cuid())
  type      String                          // CTA_CLICK | FORM_SUBMIT | PAGE_VIEW | DOWNLOAD
  page      String   @default("")
...
## .env.local
```
DATABASE_URL="file:./prisma/data/i8studio.db"
NEXTAUTH_SECRET="generate-random-64-char-string-here"

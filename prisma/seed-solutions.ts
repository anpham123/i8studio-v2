/**
 * Seed script: Populate the 9 solution services into the Service table.
 *
 * Usage:
...
interface SolutionSeed {
  ...
  heroDescJa: string;
  heroDescEn: string;
  features: { titleJa: string; titleEn: string; descJa: string; descEn: string; image: string }[];
  process: { titleJa: string; titleEn: string; descJa: string; descEn: string }[];
  plans: { name: string; features: string[]; price: string; highlighted?: boolean }[];
  order: number;
}
...
const SOLUTIONS: SolutionSeed[] = [
  {
    ...
    nameJa: "CGパース",
    icon: "Image",
    image: "/uploads/service-cg-perspective.jpg",
    heroImage: "",
    description: "Express architectural beauty through photorealistic 3DCG perspectives.",
    descriptionJa: "建築の美しさを、フォトリアリスティックな3DCGパースで表現。",
  ...
  },
  {
    ...
    nameJa: "CG動画",
    icon: "Video",
    image: "/uploads/service-cg-video.jpg",
    heroImage: "",
    description: "Dynamic architectural experiences through walkthrough and flythrough animations.",
    descriptionJa: "ウォークスルーアニメーションやフライスルー映像で、建築空間をダイナミックに体験。",
  ...
  },
  {
    ...
    nameJa: "写真合成",
    icon: "Layers",
    image: "/uploads/service-photo-composite.jpg",
    heroImage: "",
    description: "Seamlessly composite CG architecture and interiors onto real photos.",
    descriptionJa: "実写写真にCGの建築物やインテリアをシームレスに合成。",
    priceHint: "From ¥25,000",
    priceHintJa: "¥25,000〜",
  ...
  },
  {
    ...
    nameJa: "バーチャルステージング",
    icon: "Sofa",
    image: "/uploads/service-virtual-staging.jpg",
    heroImage: "",
    description: "Place virtual furniture and interiors in empty room photos.",
    descriptionJa: "空室の写真にバーチャル家具・インテリアを配置。",
    priceHint: "From ¥15,000",
    priceHintJa: "¥15,000〜",
  ...
  },
  {
    ...
    nameJa: "VR360",
    icon: "Globe",
    image: "/uploads/service-vr360.jpg",
    heroImage: "",
    description: "Experience architectural spaces in 360-degree panoramic VR.",
    descriptionJa: "パノラマVRで建築空間を360度体験。",
    priceHint: "From ¥80,000",
    priceHintJa: "¥80,000〜",
  ...
  },
  {
    ...
    heroImage: "",
    description: "Interactive experiences allowing free exploration of architectural spaces.",
    descriptionJa: "リアルタイム3D技術で建築空間を自由に歩き回れるインタラクティブ体験。",
    priceHint: "From ¥200,000",
    priceHintJa: "¥200,000〜",
  ...
  },
  {
    ...
    nameJa: "デジタル模型",
    icon: "Box",
    image: "/uploads/service-digital-model.jpg",
    heroImage: "",
    description: "Digital architecture models replacing traditional physical models.",
    descriptionJa: "従来の物理模型に代わるデジタル建築模型。",
  ...
  },
  {
    ...
    nameJa: "AR",
    icon: "Smartphone",
    image: "/uploads/service-ar.jpg",
    heroImage: "",
    description: "Overlay architecture and interiors onto real spaces through smartphones.",
    descriptionJa: "スマートフォンやタブレットを通じて、実際の空間に建築物やインテリアを重ね合わせ。",
  ...
  },
  {
    ...
    nameJa: "EXEコンテンツ",
    icon: "Monitor",
    image: "/uploads/service-exe-content.jpg",
    heroImage: "",
    description: "Interactive 3D applications that run offline.",
    descriptionJa: "オフライン動作するインタラクティブ3Dアプリケーション。",
...
async function main() {
  console.log("🌱 Seeding solution services...");

  for (const svc of SOLUTIONS) {
    await prisma.service.upsert({
      ...
      update: {
        ...
        descriptionJa: svc.descriptionJa,
        priceHint: svc.priceHint,
        priceHintJa: svc.priceHintJa,
        heroTaglineJa: svc.heroTaglineJa,
        heroTaglineEn: svc.heroTaglineEn,
        heroDescJa: svc.heroDescJa,
        heroDescEn: svc.heroDescEn,
        featuresJson: JSON.stringify(svc.features),
        processJson: JSON.stringify(svc.process),
        plansJson: JSON.stringify(svc.plans),
        order: svc.order,
        isPublished: true,
      },
      create: {
    ...
    console.log(`  ✅ ${svc.name} (${svc.slug})`);
  }

  console.log("\n🎉 Done! All 9 services seeded.");
}

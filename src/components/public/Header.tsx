...
export default function Header({ headerHeight = 76, logoImage, logoHeight = 48, services = [] }: HeaderProps) {
  ...
  const navLinks: NavItem[] = [
    ...
    { label: t("contact"), href: `/${locale}/contact` },
    {
      ...
      href: `/${locale}/blogs`,
      children: [
        { label: t("blogSub.caseStudy"),        href: `/${locale}/blogs?category=case-study` },
        { label: t("blogSub.techniqueSharing"), href: `/${locale}/blogs?category=technique` },
        { label: t("blogSub.knowledge"),        href: `/${locale}/blogs?category=knowledge` },
        { label: t("blogSub.ai"),               href: `/${locale}/blogs?category=ai` },
        { label: t("blogSub.lifeGallery"),      href: `/${locale}/blogs?category=life-gallery` },
      ],
    },
  ];

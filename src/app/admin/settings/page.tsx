...
const SETTING_GROUPS: SettingGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "workingHours", label: "Giờ làm việc (EN)", placeholder: "Mon - Fri 7:30 - 16:30 VN" },
      { key: "workingHoursJa", label: "Giờ làm việc (JA)", placeholder: "月〜金 7:30 - 16:30 (ベトナム時間)" },
  ...
  },
  {
    ...
    icon: Building2,
    fields: [
      { key: "aboutHeroTitleEn", label: "Hero tiêu đề (EN)", placeholder: "Visualizing Architectural Dreams into Vivid Reality" },
      { key: "aboutHeroTitleJa", label: "Hero tiêu đề (JA)", placeholder: "建築の夢を、鮮明な現実へと視覚化する" },
      { key: "aboutHeroDescEn", label: "Hero mô tả (EN)", type: "textarea" as const, placeholder: "Founded in 2019 in Da Nang, Vietnam..." },
      { key: "aboutHeroDescJa", label: "Hero mô tả (JA)", type: "textarea" as const, placeholder: "2019年にベトナム・ダナンで設立..." },
      { key: "aboutTitle", label: "Tiêu đề (EN)", placeholder: "About us" },
      { key: "aboutTitleJa", label: "Tiêu đề (JA)", placeholder: "会社概要" },
      { key: "aboutDesc1", label: "Mô tả dòng 1 (EN)", type: "textarea" as const },
      { key: "aboutDesc1Ja", label: "Mô tả dòng 1 (JA)", type: "textarea" as const },
      { key: "aboutDesc2", label: "Mô tả dòng 2 (EN)", type: "textarea" as const },
      { key: "aboutDesc2Ja", label: "Mô tả dòng 2 (JA)", type: "textarea" as const },
    ],
  },
  {
    title: "Giới thiệu - Thống kê trang Overview",
    icon: Globe,
    fields: [
      { key: "overviewStat1NumEn", label: "Stat 1 - Số (EN)", placeholder: "80+" },
      { key: "overviewStat1NumJa", label: "Stat 1 - Số (JA)", placeholder: "80+" },
      { key: "overviewStat1LabelEn", label: "Stat 1 - Nhãn (EN)", placeholder: "Professional Staff" },
      { key: "overviewStat1LabelJa", label: "Stat 1 - Nhãn (JA)", placeholder: "プロフェッショナルスタッフ" },

      { key: "overviewStat2NumEn", label: "Stat 2 - Số (EN)", placeholder: "5+" },
      { key: "overviewStat2NumJa", label: "Stat 2 - Số (JA)", placeholder: "5+" },
      { key: "overviewStat2LabelEn", label: "Stat 2 - Nhãn (EN)", placeholder: "Years of Experience" },
      { key: "overviewStat2LabelJa", label: "Stat 2 - Nhãn (JA)", placeholder: "年の経験" },

      { key: "overviewStat3NumEn", label: "Stat 3 - Số (EN)", placeholder: "150+" },
      { key: "overviewStat3NumJa", label: "Stat 3 - Số (JA)", placeholder: "150+" },
      { key: "overviewStat3LabelEn", label: "Stat 3 - Nhãn (EN)", placeholder: "Global Clients" },
      { key: "overviewStat3LabelJa", label: "Stat 3 - Nhãn (JA)", placeholder: "グローバルクライアント" },

      { key: "overviewStat4NumEn", label: "Stat 4 - Số (EN)", placeholder: "2,000+" },
      { key: "overviewStat4NumJa", label: "Stat 4 - Số (JA)", placeholder: "2,000+" },
      { key: "overviewStat4LabelEn", label: "Stat 4 - Nhãn (EN)", placeholder: "Completed Projects" },
      { key: "overviewStat4LabelJa", label: "Stat 4 - Nhãn (JA)", placeholder: "完了プロジェクト" },
    ],
  },
  {

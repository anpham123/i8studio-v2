...
interface Milestone { year: string; titleJa: string; titleEn: string; descJa: string; descEn: string; }
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setMilestones((m) => [...m, { year: "", titleJa: "", titleEn: "", descJa: "", descEn: "" }])} className="flex items-center gap-1 text-blue-600 text-xs font-medium hover:text-blue-700"><Plus size={14} /> Thêm</button>
              </div>
              {milestones.map((ms, i) => (
